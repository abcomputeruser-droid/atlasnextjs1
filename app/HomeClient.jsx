    ...
    <>
      ...
      <main>
        <section className="hero product-hero product-hero--video" id="top">
          <video className="product-hero-video" autoPlay muted loop playsInline preload="none" disablePictureInPicture disableRemotePlayback data-playback-rate="0.5" aria-hidden="true">
