...
function normalizePathValue(value) {
  ...
  nextValue = nextValue.replace(/\/index\.html$/i, "/");
  nextValue = nextValue.replace(/\.html$/i, "");
...
function initNavActivePage() {
  ...
  const currentPage = normalizePathValue(window.location.pathname);

  links.forEach((a) => {
    const href = normalizePathValue(a.getAttribute("href"));
